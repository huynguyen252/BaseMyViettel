...
public abstract class BaseActivity extends BaseGlobalActivity {
  ...
  public void ngaAddFragment(int containerId, BaseFragment fragment, boolean addToBackStack,
                          String tag) {
    ActivityUtils.ngaAddFragmentToActivity(getSupportFragmentManager(), fragment, containerId,
            addToBackStack, tag, false);
  }
