...
public class Constants {
    ...
    public static final String BASE_SERVER_URL = "http://68.183.226.200:3000/api/muasim/";
    public static final String BASE_SERVER_URL_MY_VIETTEL = "http://apivtp.vietteltelecom.vn/myviettel.php/";
